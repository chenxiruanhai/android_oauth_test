...
//	public static final String Sina_Access_Token2 = "https://api.weibo.com/oauth2/access_token?client_id=" + SINA_APP_KEY + "&client_secret=" + SINA_APP_SECRET + "&grant_type=authorization_code&redirect_uri=" + SINA_OAUTH_CALLBACK + "&code=";
